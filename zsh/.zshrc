...
__conda_setup="$('/home/jesus/miniconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/jesus/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/jesus/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/jesus/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
# Created by `pipx` on 2024-10-19 21:40:58
...
#mapping touch-screens to correct dp links
